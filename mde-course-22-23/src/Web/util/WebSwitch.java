	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case WebPackage.WEBSITE: {
				...
				if (result == null) result = caseNamedClass(website);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case WebPackage.ENTITY: {
				...
				if (result == null) result = caseNamedClass(entity);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case WebPackage.PAGE: {
				...
				if (result == null) result = caseNamedClass(page);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case WebPackage.FORM: {
				...
				if (result == null) result = caseNamedClass(form);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case WebPackage.FEATURE: {
				Feature feature = (Feature)theEObject;
				T result = caseFeature(feature);
				if (result == null) result = caseNamedClass(feature);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case WebPackage.ATTRIBUTE: {
				...
				if (result == null) result = caseNamedClass(attribute);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case WebPackage.REFERENCE: {
				Reference reference = (Reference)theEObject;
				T result = caseReference(reference);
				if (result == null) result = caseFeature(reference);
				if (result == null) result = caseNamedClass(reference);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
