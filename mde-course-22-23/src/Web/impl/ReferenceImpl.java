 ...
 * </p>
 * <ul>
 *   <li>{@link Web.impl.ReferenceImpl#getForeignKey <em>Foreign Key</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ReferenceImpl extends FeatureImpl implements Reference {
	...
	protected EClass eStaticClass() {
		return WebPackage.Literals.REFERENCE;
	}
		...
		if (foreignKey != null && foreignKey.eIsProxy()) {
			...
			if (foreignKey != oldForeignKey) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WebPackage.REFERENCE__FOREIGN_KEY, oldForeignKey, foreignKey));
			}
		}
		return foreignKey;
	}
	...
	public void setForeignKey(Entity newForeignKey) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebPackage.REFERENCE__FOREIGN_KEY, oldForeignKey, foreignKey));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WebPackage.REFERENCE__FOREIGN_KEY:
